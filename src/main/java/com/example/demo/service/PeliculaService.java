...
public class PeliculaService {
    private List<PeliculaDtoRp> listPeliculas = new ArrayList<>();

    public PeliculaService() {
        this.listPeliculas.add(new PeliculaDtoRp(
    ...
    public List<PeliculaDtoRp> getListPeliculas() {
        return listPeliculas;
    }

    public PeliculaDtoRp getPeliculaById(int id) {
        PeliculaDtoRp peliculaDtoRps;
        try {
